...
object PrefsJson {
    ...
    private fun serializeOverlayPrefs(context: Context): JSONArray {
        ...
        putString("overlay_hud_alert_source", OverlayPrefs.hudAlertSource(context).storedValue)
        putFloat("overlay_hudspeed_x_dp", hudSpeedPos.x)
        putFloat("overlay_hudspeed_y_dp", hudSpeedPos.y)
        putFloat("overlay_strelka_x_dp", strelkaPos.x)
        putFloat("overlay_strelka_y_dp", strelkaPos.y)
        ...
        putFloat("overlay_strelka_scale", OverlayPrefs.strelkaScale(context))
        ...
        putFloat("overlay_strelka_alpha", OverlayPrefs.strelkaAlpha(context))
        ...
        putBoolean("overlay_nav_show_distance", OverlayPrefs.navShowDistance(context))
        ...
        putBoolean("overlay_arrow_hide_when_map_active", OverlayPrefs.arrowHideWhenMapActive(context))
        ...
        putBoolean("overlay_speed_hide_when_map_active", OverlayPrefs.speedHideWhenMapActive(context))
        ...
        putBoolean("overlay_hudspeed_hide_when_map_active", OverlayPrefs.hudSpeedHideWhenMapActive(context))
        putBoolean("overlay_strelka_hide_when_map_active", OverlayPrefs.strelkaHideWhenMapActive(context))
        ...
        putBoolean("overlay_road_camera_hide_when_map_active", OverlayPrefs.roadCameraHideWhenMapActive(context))
        putBoolean("overlay_traffic_light_enabled", OverlayPrefs.trafficLightEnabled(context))
        putBoolean("overlay_traffic_light_hide_when_map_active", OverlayPrefs.trafficLightHideWhenMapActive(context))
        ...
        putBoolean("overlay_speedometer_hide_when_map_active", OverlayPrefs.speedometerHideWhenMapActive(context))
        ...
        putBoolean("overlay_turn_signals_hide_when_map_active", OverlayPrefs.turnSignalsHideWhenMapActive(context))
        ...
        putBoolean("hide_turn_dynamic_hide_map_block", OverlayPrefs.hideTurnDynamicHideMapBlock(context))
    ...
    private fun serializeMapRenderPrefs(context: Context): JSONArray {
        ...
        putInt("arrow_offset_dp", settings.arrowOffsetDp)
